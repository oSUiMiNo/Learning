...
教材を作る・直すときは、先にこの 2 つを読んでください。
1 冊作る過程で実際に踏んだ間違いと、その対処をまとめてあります。

| 手引き | 内容 |
|---|---|
| [AUTHORING.md](AUTHORING.md) | **共通ルール。**分野を問わず効くこと。正しさの担保、素材づくり、サイト生成の罠、書き方、進め方、チェックリスト |
| [qt6-widgets/AUTHORING.md](qt6-widgets/AUTHORING.md) | Qt6 Widgets 入門で実際に起きたこと。GUI とスクリーンショット固有の話 |

新しい教材を作ったら、`<教材名>/AUTHORING.md` を残してください。
**共通ルールと重複することは書かず、その教材でしか起きなかったことだけ**を書きます。
