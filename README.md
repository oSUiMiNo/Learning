...
新しく教材を作る（または既存のものを直す）ときは、先に
**[AUTHORING.md](AUTHORING.md) — 教材づくりの手引き** を読んでください。
Qt6 の教材を 1 冊作る過程で実際に踏んだ間違いと、その対処をまとめてあります。
「Web の記事を信じて書いた早見表が 5 行間違っていた」といった実例が中心です。
...
├── AUTHORING.md       教材づくりの手引き（過去に踏んだ間違いと対処）
└── tools/
