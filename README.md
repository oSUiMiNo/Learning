...
教材を作る・直すときは、実際に踏んだ間違いと対処をまとめた手引きを先に読んでください。
手引きは 2 階層あります。

1. [AUTHORING.md](AUTHORING.md) — **共通ルール。**分野を問わず効くこと。
   正しさの担保、素材づくり、サイト生成の罠、書き方、進め方、チェックリスト
2. `<教材名>/AUTHORING.md` — **その教材で実際に起きたこと。**
   上の表の教材リンクからたどれます（まだ無い教材もあります）
...
逆に共通編だけ書くと、具体例が失われて自分ごとになりません。

切り分けの判定基準（「次に別の分野の教材を作るとき、同じことをまた書くか？」）と
手順は、共通ルールの 8 節にあります。

研究の途中で分かったことは、教材化の指示が無くても随時 `<教材名>/メモ/` に
残しています。書き方・反映手順は [MEMO.md](MEMO.md)、整合性は
`python tools/check_memos.py` で確認できます。
