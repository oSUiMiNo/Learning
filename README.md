...
教材を作る・直すときは、**先にその教材の `AUTHORING.md` を読んでください。**
1 冊作る過程で実際に踏んだ間違いと、その対処をまとめてあります。

| 手引き | 内容 |
|---|---|
| [qt6-widgets/AUTHORING.md](qt6-widgets/AUTHORING.md) | Qt6 Widgets 入門を作って分かったこと。「Web の記事を信じて書いた早見表が 5 行間違っていた」など |

新しい教材を作ったら、同じように `<教材名>/AUTHORING.md` を残してください。
分野が違えば担保のしかたも変わるので、教材ごとに 1 冊ぶんずつ書くほうが実用的です。
